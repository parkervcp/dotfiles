...
if [ -f /etc/redhat-release ]; then
    ...
    if cat /etc/redhat-release | grep -i -q fedora; then
        ...
        sudo dnf install jack-audio-connection-kit jack-audio-connection-kit-dbus jack-audio-connection-kit-devel jack-audio-connection-kit-example-clients jack_capture pulseaudio-module-jack
